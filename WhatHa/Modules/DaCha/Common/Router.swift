...
//  WhatFilm
//
//  Created by Jason Kim on 10/09/2018.
...
public struct TVSearchParameters {
    ...
    var nextPage: TVSearchParameters {
        guard let page = self.page else { return self }
        return TVSearchParameters(query: self.query, page: page + 1, language: self.language, includeAdult: self.includeAdult, year: self.year, primaryReleaseYear: self.primaryReleaseYear)
    }
...
extension TVSearchParameters: URLParametersListSerializable {
...
public enum Router: URLRequestConvertible {
    ...
    var path: String {
        ...
        case .popularTVs(_): return "/tv/airing_today"
        case .popularFilms(_): return "/movie/now_playing"
        ...
        case .searchTVs(_): return "/search/tv"
        case .tvDetail(let tvID): return "/tv/\(tvID)"
        case .tvCredits(let tvID): return "/tv/\(tvID)/credits"
        }
    }
    ...
    var httpMethod: Alamofire.HTTPMethod {
        ...
        case .searchTVs(_): return .get
        case .tvDetail(_): return .get
        case .tvCredits(_): return .get
        }
    }
    ...
    case searchTVs(parameters: TVSearchParameters)
    case tvDetail(tvId: Int)
    case tvCredits(tvId: Int)
